...
| [Command replay and downwash](43-command-replay-and-downwash.md) | Why an upward command may still descend, the matched physical interventions, and their interpretation limits |
| [Steering out of a modeled rotor wake](44-local-wake-clearance.md) | A worked local geometry example, bounded command selection, and why closed-loop policy testing follows |
| [What changes when the actor sees its guarded flight?](45-closed-loop-guard-evaluation.md) | Recurrent feedback, original versus guarded commands, and a matched physical comparison |
