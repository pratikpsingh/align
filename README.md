...
- [Critic normalization floor](docs/25-critic-normalization-floor.md): conservative historical candidate selection, schema-2 checkpoints, and accepted floored-curve evidence.
- [Segmented training](docs/26-segmented-training.md): bounded fresh-process training segments with checkpoint and normalization continuity.
