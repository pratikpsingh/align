...
- [Frozen critic normalization](docs/23-frozen-critic-normalization.md): active-group warmup statistics, checkpoint restoration, evaluation immutability, and lab command.
