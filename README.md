...
- [Critic normalization floor](docs/25-critic-normalization-floor.md): conservative historical candidate selection, schema-2 checkpoints, and the pending floored-curve acceptance.
